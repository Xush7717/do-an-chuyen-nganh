  ...
  <footer class="bg-slate-900 text-slate-300 border-t border-slate-800 ">
    <div class="container mx-auto px-4 py-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <!-- Brand Column -->
        <div class="space-y-6">
          <NuxtLink to="/" class="font-display font-bold text-3xl text-white no-underline block">
            MarketMini
          </NuxtLink>
          <p class="text-slate-400 leading-relaxed">
            The premium marketplace for unique finds. Connect with sellers and discover extraordinary items today.
          </p>
        ...
        <!-- Newsletter Column -->
        <div>
          <h3 class="text-white font-display font-bold text-lg mb-6">Stay in the loop</h3>
          <p class="text-slate-400 mb-4">Join our newsletter for exclusive offers and updates.</p>
          <form @submit.prevent="subscribeToNewsletter" class="space-y-3">
            <input
              ...
              required
              class="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent text-white placeholder-slate-500 transition-all"
            >
            <button
              type="submit"
              class="w-full px-6 py-3 bg-primary text-white font-medium rounded-xl hover:bg-primary-700 hover:shadow-lg hover:shadow-primary/25 transition-all duration-300"
            >
              Subscribe
            </button>
          </form>
